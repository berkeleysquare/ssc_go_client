...
package openapi
// ApiStorageLocationAmazonS3 Used to create AmazonS3 storage locations.
type ApiStorageLocationAmazonS3 struct {
	// For use only with AmazonS3.  The access key ID of the credentials for AmazonS3.
	...
	// Used for AmazonS3 endpoints.  The bucket to use for storage.
	...
	// For use only with AmazonS3 or S3 emulators.  The URL of the endpoint to which the server should connect to access the storage.
	S3Endpoint *string `json:"s3Endpoint,omitempty" xml:"s3Endpoint"`
	// For use only with AmazonS3 or S3 emulators.  The S3 region in which to connect.  If empty, the default region is assumed.
	...
	// For use only with AmazonS3.  The secret access key of the credentials for AmazonS3. This is write-only.
