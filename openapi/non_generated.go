...
// Additional functions required by client but not provided by openAPI
...
/* ADDED BY JK -- NOT GENERATED */
func (a *ProjectApiService) SearchJobs(ctx _context.Context, projectName string, localVarOptionals *ProjectApiListJobsOpts) (ApiJobPaginator, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  ApiJobPaginator
	)

	// create path and map variables
	// non public API -- /api instead of /openapi
	privateApiPath := strings.Replace(a.client.cfg.BasePath, "/openapi", "/api", 1)
	localVarPath := privateApiPath + "/search/projects/containing"
	// localVarPath = strings.Replace(localVarPath, "{"+"projectName"+"}", _neturl.QueryEscape(parameterToString(projectName, "")) , -1)
	...
	if localVarOptionals == nil {
		// default all but project name
		localVarOptionals = MakeProjectApiListJobsOpts(projectName)
	}
	localVarQueryParams.Add("limit", parameterToString(localVarOptionals.Limit, ""))
	localVarQueryParams.Add("projectText", parameterToString(localVarOptionals.ProjectName, ""))
	localVarQueryParams.Add("sortBy", parameterToString(localVarOptionals.SortBy, ""))
	localVarQueryParams.Add("sortType", parameterToString(localVarOptionals.SortType, ""))
...
func (a *ProjectApiService) GetJobStatus(ctx _context.Context, jobName string) (ApiJobStatus, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  ApiJobStatus
	)

	// create path and map variables
	// non public API -- /api instead of /openapi
	privateApiPath := strings.Replace(a.client.cfg.BasePath, "/openapi", "/api", 1)
	localVarPath := privateApiPath + "/jobs/" + jobName + "/status"
...
func (a *ProjectApiService) SearchObjects(ctx _context.Context, match string, localVarOptionals *ProjectApiListJobsOpts) (ApiJobPaginator, *_nethttp.Response, error) {
	...
	// non public API -- /api instead of /openapi
	privateApiPath := strings.Replace(a.client.cfg.BasePath, "/openapi", "/api", 1)
	localVarPath := privateApiPath + "/search/files/containing"
	...
	if localVarOptionals == nil {
		// default all but project name
		localVarOptionals = MakeApiListJobsWithObjectsOpts(match)
	}
	localVarQueryParams.Add("limit", parameterToString(localVarOptionals.Limit, ""))
	localVarQueryParams.Add("fileOrFolderName", parameterToString(localVarOptionals.FileOrFolderName, ""))
	localVarQueryParams.Add("sortBy", parameterToString(localVarOptionals.SortBy, ""))
	localVarQueryParams.Add("sortType", parameterToString(localVarOptionals.SortType, ""))
...
func (a *ProjectApiService) SearchProjects(ctx _context.Context, match string, localVarOptionals *SearchApiProjectsOpts) (ApiSearchProjectPaginator, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  ApiSearchProjectPaginator
	)

	// create path and map variables
	// non public API -- /api instead of /openapi
	privateApiPath := strings.Replace(a.client.cfg.BasePath, "/openapi", "/api", 1)
	localVarPath := privateApiPath + "/search/projects/projects"
	...
	if localVarOptionals == nil {
		// default all but project name
		localVarOptionals = MakeSearchApiProjectsOpts(match)
	}
	localVarQueryParams.Add("limit", parameterToString(localVarOptionals.Limit, ""))
	localVarQueryParams.Add("tag", localVarOptionals.Tag)
...
func (a *ProjectApiService) GetCatalog(ctx _context.Context, job string, localVarOptionals *ProjectApiListCatalogOpts) (ApiManifestFilesPaginator, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  ApiManifestFilesPaginator
	)

	// create path and map variables
	// non public API -- /api instead of /openapi
	privateApiPath := strings.Replace(a.client.cfg.BasePath, "/openapi", "/api", 1)
	localVarPath := privateApiPath + "/manifests/" + _neturl.PathEscape(job) + "/files"
	...
	if localVarOptionals == nil {
		// default all but project name
		localVarOptionals = MakeProjectApiListCatalogOpts(job)
	}
	localVarQueryParams.Add("limit", parameterToString(localVarOptionals.Limit, ""))
	localVarQueryParams.Add("skip", parameterToString(localVarOptionals.Skip, ""))
...
/* ADDED BY JK -- NOT GENERATED */
func (a *ProjectApiService) GetAllJobs(ctx _context.Context, jobType string, localVarOptionals *ProjectApiListJobsOpts) (ApiJobsWithStatusPaginator, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  ApiJobsWithStatusPaginator
	)

	// create path and map variables
	// non public API -- /api instead of /openapi
	privateApiPath := strings.Replace(a.client.cfg.BasePath, "/openapi", "/api", 1)
	localVarPath := privateApiPath + "/jobs"
	...
	if localVarOptionals == nil {
		// default all but project name
		localVarOptionals = MakeProjectApiListAllJobsOpts(jobType)
	}
	localVarQueryParams.Add("limit", parameterToString(localVarOptionals.Limit, ""))
	localVarQueryParams.Add("sortBy", parameterToString(localVarOptionals.SortBy, ""))
	localVarQueryParams.Add("sortType", parameterToString(localVarOptionals.SortType, ""))
	if len(localVarOptionals.FilterBy) > 0 {
		localVarQueryParams.Add("filterBy", parameterToString(localVarOptionals.FilterBy, ""))
	}
