...
package openapi
// ApiStorageLocationMsAzure Used to create MSAzure storage locations.
type ApiStorageLocationMsAzure struct {
	// For use only with MSAzure.  The access key ID of the credentials for MSAzure.
	AccessKeyId *string `json:"accessKeyId" xml:"accessKeyId"`
	// Used to re-activate a 'deleted' storage location.
	Active *bool `json:"active,omitempty" xml:"active"`
	// Used for MSAzure endpoints.  The container to use for storage.
	...
	// Prevent location from use as a source. Set to true for MSAzure.
	...
	// For use only with MSAzure.  The secret access key of the credentials for MSAzure. This is write-only.
