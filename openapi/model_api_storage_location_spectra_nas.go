...
package openapi
// ApiStorageLocationSpectraNas Used to create SpectraNAS storage locations.
type ApiStorageLocationSpectraNas struct {
	...
	// For use only with SpectraNAS.  The URL of the SpectraNAS server management port.
	SpectraMgmtEndpoint *string `json:"spectraMgmtEndpoint" xml:"spectraMgmtEndpoint"`
	// For use only with SpectraNAS.  The password to login to the management port.  This is write-only.
	SpectraPassword *string `json:"spectraPassword" xml:"spectraPassword"`
	// For use only with SpectraNAS.  The username to login to the management port.
	...
	// Used for SpectraNAS locations, this is the filesystem path to the NAS mount point.
